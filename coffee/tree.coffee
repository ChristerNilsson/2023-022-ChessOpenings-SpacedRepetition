...
export class Tree
	...
	test : =>
		...
		if SIZE == 2
			...
			ass @facit(4585,4900), [['g8f6', 5, 146, 529], ['f8c5', 5, 1, 454], ['f8e7', 5, 305, 19], ['g7g6', 5, 312, 12], ['f7f5', 5, 311, 8], ['d7d6', 5, 313, 8], ['a7a6', 5, 310, 5]]
			ass @facit(4731,4900), [['d2d3',6,1,358],['f3g5',6,108,95],['d2d4', 6, 85, 33],['e1g1', 6, 154, 22],['b1c3', 6, 145, 11],['c2c3', 6, 158, 8]]
